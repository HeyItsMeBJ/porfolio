  ...
  return (
    <section className="about container section" id="about">
      ...
      <div className="about__container grid">
        <img src={Mypic} alt="" width="190" className="about__img" style={{
          borderRadius: "50%",
        }}/>

        <div className="about__data grid">
          <div className="about__info">
            <p className="about__description">I am Bhupesh Jain. I am Well-versed in MERN Stack Development (MongoDB, Express.js, React.js, Node.js) along with that I am good at Data Structure & Algorithms, and Competitive Programming.<br/><br/>
            I am Passionate and Curious about Programming. I have Built many Full-stack Projects with the same technologies as well. </p>
            <a href="https://drive.google.com/file/d/1UuRDHgxFsk4ZoV_LUaF3GKN0KoITY7bR/view?usp=drive_link" className="btn">Download CV</a>
          </div>
